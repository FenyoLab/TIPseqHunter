...
tipseqjar=/ifs/home/tangz01/PhDCourses/PhDProposal/TIPseqHunter-Pipeline-Package/JavaPackage/TIPseqHunter2/TIPseqHunter2.jar # download from my website
...
positive_anno_file=ucsc.rm327.rmsk.L1HS.coord.with-strand.txt.Ta.only.bed # download from my website (ucsc.rm327.rmsk.L1Hs-Ta.with-strand.matchFP.bed)(ucsc.rm327.rmsk.L1HS.coord.with-strand.bed)(ucsc.rm327.rmsk.L1HS.coord.with-strand.txt.Ta.only.bed)
